...
int initialise(void)
{
    ...
    /* Copy in starting state and conditions from flash memory */
    memcpy(game, &GAME_CONST, sizeof(game_t));
    memcpy(conditions, &CONDITIONS_CONST, 185 * sizeof(long));
