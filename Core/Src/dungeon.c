...
const char * const arbitrary_messages[210] = {
    NULL,
...
const turn_threshold_t turn_thresholds[4] = {
    {
        .threshold = 350,
        .point_loss = 2,
...
const object_t objects[70] = {
    { // 0: NO_OBJECT
        ...
        .fixd = LOC_NOWHERE,
        .is_treasure = false,
        .descriptions = (const char* const []) {
            NULL,
        },
        .sounds = (const char* const []) {
            NULL,
        },
        .texts = (const char* const []) {
            NULL,
        },
        .changes = (const char* const []) {
            NULL,
        },
    },
    { // 1: KEYS
        .words = {
            .strs = (const char* const []) {"keys", "key"},
            .n = 2,
        },
    ...
    { // 2: LAMP
        .words = {
            .strs = (const char* const []) {"lamp", "lante"},
            .n = 2,
        },
    ...
    { // 10: PILLOW
        .words = {
            .strs = (const char* const []) {"pillo", "velve"},
            .n = 2,
        },
    ...
    { // 16: MAGAZINE
        .words = {
            .strs = (const char* const []) {"magaz", "issue", "spelu", "\"spel"},
            .n = 4,
        },
    ...
    { // 17: DWARF
        .words = {
            .strs = (const char* const []) {"dwarf", "dwarv"},
            .n = 2,
        },
        .inventory = NULL,
        .plac = LOC_NOWHERE,
    ...
    { // 18: KNIFE
        .words = {
            .strs = (const char* const []) {"knife", "knive"},
            .n = 2,
        },
        .inventory = NULL,
        .plac = LOC_NOWHERE,
    ...
    { // 19: FOOD
        .words = {
            .strs = (const char* const []) {"food", "ratio"},
            .n = 2,
        },
    ...
    { // 20: BOTTLE
        .words = {
            .strs = (const char* const []) {"bottl", "jar"},
            .n = 2,
        },
    ...
    { // 21: WATER
        .words = {
            .strs = (const char* const []) {"water", "h2o"},
            .n = 2,
        },
    ...
    { // 24: PLANT
        .words = {
            .strs = (const char* const []) {"plant", "beans"},
            .n = 2,
        },
        .inventory = "*plant",
        .plac = LOC_WESTPIT,
    ...
    { // 27: OBJ_27
        .words = {
            .strs = (const char* const []) {"shado", "figur", "windo"},
            .n = 3,
        },
    ...
    { // 30: OBJ_30
        .words = {
            .strs = (const char* const []) {"pirat", "genie", "djinn"},
            .n = 3,
        },
    ...
    { // 37: VOLCANO
        .words = {
            .strs = (const char* const []) {"volca", "geyse"},
            .n = 2,
        },
    ...
    { // 38: VEND
        .words = {
            .strs = (const char* const []) {"machi", "vendi"},
            .n = 2,
        },
    ...
    { // 40: OBJ_40
        .words = {
            .strs = (const char* const []) {"carpe", "moss"},
            .n = 2,
        },
    ...
    { // 46: RABBITFOOT
        .words = {
            .strs = (const char* const []) {"appen", "lepor"},
            .n = 2,
        },
    ...
    { // 50: NUGGET
        .words = {
            .strs = (const char* const []) {"gold", "nugge"},
            .n = 2,
        },
    ...
    { // 52: OBJ_52
        .words = {
            .strs = (const char* const []) {"silve", "bars"},
            .n = 2,
        },
    ...
    { // 55: CHEST
        .words = {
            .strs = (const char* const []) {"chest", "box", "treas"},
            .n = 3,
        },
    ...
    { // 56: EGGS
        .words = {
            .strs = (const char* const []) {"eggs", "egg", "nest"},
            .n = 3,
        },
    ...
    { // 58: VASE
        .words = {
            .strs = (const char* const []) {"vase", "ming", "shard", "potte"},
            .n = 4,
        },
        .inventory = "Ming vase",
        .plac = LOC_ORIENTAL,
    ...
    { // 60: PYRAMID
        .words = {
            .strs = (const char* const []) {"plati", "pyram"},
            .n = 2,
        },
    ...
    { // 62: RUG
        .words = {
            .strs = (const char* const []) {"rug", "persi"},
            .n = 2,
        },
    ...
    { // 66: JADE
        .words = {
            .strs = (const char* const []) {"jade", "neckl"},
            .n = 2,
        },
    ...
    { // 67: AMBER
        .words = {
            .strs = (const char* const []) {"amber", "gemst"},
            .n = 2,
        },
    ...
    { // 69: OBJ_69
        .words = {
            .strs = (const char* const []) {"ebony", "statu"},
            .n = 2,
        },
...
const motion_t motions[76] = {
    ...
    {
        .words = {
            .strs = (const char* const []) {"road", "hill"},
            .n = 2,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"enter"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"upstr"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"downs"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"fores"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"forwa", "conti", "onwar"},
            .n = 3,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"back", "retur", "retre"},
            .n = 3,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"valle"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"stair"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"out", "outsi", "exit", "leave"},
            .n = 4,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"build", "house"},
            .n = 2,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"gully"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"strea"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"fork"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"bed"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"crawl"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"cobbl"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"inwar", "insid", "in"},
            .n = 3,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"surfa"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"null", "nowhe"},
            .n = 2,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"dark"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"passa", "tunne"},
            .n = 2,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"low"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"canyo"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"awkwa"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"giant"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"view"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"upwar", "up", "u", "above", "ascen"},
            .n = 5,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"d", "downw", "down", "desce"},
            .n = 4,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"pit"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"outdo"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"crack"},
            .n = 1,
        },
    },
    {
    ...
    {
        .words = {
            .strs = (const char* const []) {"dome"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"left"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"right"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"hall"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"jump"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"barre"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"over"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"acros"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"east", "e"},
            .n = 2,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"west", "w"},
            .n = 2,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"north", "n"},
            .n = 2,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"south", "s"},
            .n = 2,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"ne"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"se"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"sw"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"nw"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"debri"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"hole"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"wall"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"broke"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"y2"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"climb"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"l", "x", "look", "exami", "touch", "descr"},
            .n = 6,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"floor"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"room"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"slit"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"slab", "slabr"},
            .n = 2,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"xyzzy"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"depre"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"entra"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"plugh"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"secre"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"cave"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"cross"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"bedqu"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"plove"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"orien"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"caver"},
            .n = 1,
        },
    },
    {
        .words = {
            .strs = (const char* const []) {"shell"},
            .n = 1,
        },
    },
    {
    ...
    {
        .words = {
            .strs = (const char* const []) {"main", "offic"},
            .n = 2,
        },
    },
...
const action_t actions[58] = {
    {
        .words = {
            .strs = NULL,
            .n = 0,
        },
        .message = (const char* const)NULL,
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"g", "carry", "take", "keep", "catch", "steal", "captu", "get", "tote", "snarf"},
            .n = 10,
        },
    ...
    {
        .words = {
            .strs = (const char* const []) {"drop", "relea", "free", "disca", "dump"},
            .n = 5,
        },
        .message = (const char* const)"You aren\'t carrying it!",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"say", "chant", "sing", "utter", "mumbl"},
            .n = 5,
        },
        .message = (const char* const)"NO_MESSAGE",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"unloc", "open"},
            .n = 2,
        },
        .message = (const char* const)"I don\'t know how to lock or unlock such a thing.",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"z", "nothi"},
            .n = 2,
        },
        .message = (const char* const)"NO_MESSAGE",
        .noaction = false,
    ...
    {
        .words = {
            .strs = (const char* const []) {"lock", "close"},
            .n = 2,
        },
        .message = (const char* const)"I don\'t know how to lock or unlock such a thing.",
        .noaction = false,
    ...
    {
        .words = {
            .strs = (const char* const []) {"light", "on"},
            .n = 2,
        },
        .message = (const char* const)"I\'m afraid I don\'t understand.",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"extin", "off"},
            .n = 2,
        },
        .message = (const char* const)"I\'m afraid I don\'t understand.",
        .noaction = false,
    ...
    {
        .words = {
            .strs = (const char* const []) {"wave", "shake", "swing"},
            .n = 3,
        },
        .message = (const char* const)"Nothing happens.",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"calm", "placa", "tame"},
            .n = 3,
        },
        .message = (const char* const)"I\'m game.  Would you care to explain how?",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"walk", "run", "trave", "go", "proce", "conti", "explo", "follo", "turn"},
            .n = 9,
        },
        .message = (const char* const)"Where?",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"attac", "kill", "fight", "hit", "strik", "slay"},
            .n = 6,
        },
        .message = (const char* const)"Don\'t be ridiculous!",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"pour"},
            .n = 1,
        },
        .message = (const char* const)"You aren\'t carrying it!",
        .noaction = false,
    ...
    {
        .words = {
            .strs = (const char* const []) {"eat", "devou"},
            .n = 2,
        },
        .message = (const char* const)"Don\'t be ridiculous!",
        .noaction = false,
    ...
    {
        .words = {
            .strs = (const char* const []) {"drink"},
            .n = 1,
        },
        .message = (const char* const)"You have taken a drink from the stream.  The water tastes strongly of\r\nminerals, but is not unpleasant.  It is extremely cold.",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"rub"},
            .n = 1,
        },
        .message = (const char* const)"Rubbing the electric lamp is not particularly rewarding.  Anyway,\r\nnothing exciting happens.",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"throw", "toss"},
            .n = 2,
        },
        .message = (const char* const)"You aren\'t carrying it!",
        .noaction = false,
    ...
    {
        .words = {
            .strs = (const char* const []) {"quit"},
            .n = 1,
        },
        .message = (const char* const)"Huh?",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"find", "where"},
            .n = 2,
        },
        .message = (const char* const)"I can only tell you what you see as you move about and manipulate\r\nthings.  I cannot tell you where remote things are.",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"i", "inven"},
            .n = 2,
        },
        .message = (const char* const)"I can only tell you what you see as you move about and manipulate\r\nthings.  I cannot tell you where remote things are.",
        .noaction = false,
    ...
    {
        .words = {
            .strs = (const char* const []) {"feed"},
            .n = 1,
        },
        .message = (const char* const)"There is nothing here to eat.",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"fill"},
            .n = 1,
        },
        .message = (const char* const)"You can\'t fill that.",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"blast", "deton", "ignit", "blowu"},
            .n = 4,
        },
        .message = (const char* const)"Blasting requires dynamite.",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"score"},
            .n = 1,
        },
        .message = (const char* const)"Huh?",
        .noaction = false,
    ...
    {
        .words = {
            .strs = (const char* const []) {"fee"},
            .n = 1,
        },
        .message = (const char* const)"I don\'t know how.",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"fie"},
            .n = 1,
        },
        .message = (const char* const)"I don\'t know how.",
        .noaction = false,
    ...
    {
        .words = {
            .strs = (const char* const []) {"brief"},
            .n = 1,
        },
        .message = (const char* const)"On what?",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"read", "perus"},
            .n = 2,
        },
        .message = (const char* const)"I\'m afraid I don\'t understand.",
        .noaction = false,
    ...
    {
        .words = {
            .strs = (const char* const []) {"break", "shatt", "smash"},
            .n = 3,
        },
        .message = (const char* const)"It is beyond your power to do that.",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"wake", "distu"},
            .n = 2,
        },
        .message = (const char* const)"Don\'t be ridiculous!",
        .noaction = false,
    ...
    {
        .words = {
            .strs = (const char* const []) {"suspe", "pause", "save"},
            .n = 3,
        },
        .message = (const char* const)"Huh?",
        .noaction = false,
    ...
    {
        .words = {
            .strs = (const char* const []) {"resum", "resta"},
            .n = 2,
        },
        .message = (const char* const)"Huh?",
        .noaction = false,
    ...
    {
        .words = {
            .strs = (const char* const []) {"seed"},
            .n = 1,
        },
        .message = (const char* const)"Seed set to %d",
        .noaction = false,
    },
    {
        .words = {
            .strs = (const char* const []) {"waste"},
            .n = 1,
        },
        .message = (const char* const)"Game limit is now %d",
        .noaction = false,
    },
    {
        .words = {
    ...
    {
        .words = {
            .strs = (const char* const []) {"wizar"},
            .n = 1,
        },
        .message = (const char* const)"Wizards are not to be disturbed by such as you.",
        .noaction = true,
    },
    {
        .words = {
            .strs = (const char* const []) {"yes"},
            .n = 1,
        },
        .message = (const char* const)"Guess again.",
        .noaction = true,
    },
    {
        .words = {
            .strs = (const char* const []) {"news"},
            .n = 1,
        },
        .message = (const char* const)"Open Adventure is an author-approved open-source release of\r\nVersion 2.5 with, as yet, no gameplay changes.\r\nVersion 2.5 was essentially the same as Version II; the cave and the\r\nhazards therein are unchanged, and top score is still 430 points.\r\nThere are a few more hints, especially for some of the more obscure\r\npuzzles.  There are a few minor bugfixes and cosmetic changes.  You\r\ncan now save a game and resume it at once (formerly you had to wait a\r\nwhile first), but it now costs you a few points each time you save the\r\ngame.  Saved games are now stored in much smaller files than before.",
        .noaction = true,
    },
    {
        .words = {
            .strs = (const char* const []) {"versi"},
            .n = 1,
        },
        .message = (const char* const)"There is a puff of orange smoke; within it, fiery runes spell out:\r\n\r\n\tOpen Adventure %V - http://www.catb.org/esr/open-adventure/",
        .noaction = true,
    },
};
