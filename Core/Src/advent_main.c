...
/* Definitions for adventureSem */
osSemaphoreId_t adventureSemHandle;
const osSemaphoreAttr_t adventureSem_attributes = {
  .name = "adventureSem"
};


void StartAdventureTask(void *argument)
{
  for(;;)
  {
      adventmain();
...
void adventmain()
{
    ...
    game = (game_t*)pvPortMalloc(sizeof(game_t));
    ...
    conditions = (long*)pvPortMalloc(185 * sizeof(long));
